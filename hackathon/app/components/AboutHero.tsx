...
const AboutHero = () => {
  return (
    <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row items-center bg-white mt-16 md:mt-32 px-4 sm:px-6 lg:px-12 gap-6">
      {/* Text Section */}
      <div className="w-full md:w-[650px] h-auto md:h-[478px] bg-[#007580] p-6 flex flex-col justify-start items-start text-left text-white">
        ...
        <p className="text-[16px] md:text-[18px] font-normal leading-7 pt-4 pl-4 md:pl-6 pb-12 md:pb-40">
        ...
        <div className="pl-4 md:pl-6">
          <button
            ...
            className="bg-[#2e6a6d] text-white px-6 md:px-8 py-3 md:py-4 text-[14px] md:text-[16px] font-normal rounded-md hover:bg-[#225354] transition-colors duration-300"
          >
            View collection
          </button>
        </div>
      ...
      <div className="w-full md:w-[619px] h-auto md:h-[478px] mt-6 md:mt-0 md:ml-6">
        <Image
          src="/Image Block.png"
          alt="Image showcasing Comforty collection"
          width={619}
          height={478}
          className="object-cover w-full h-full rounded-lg hover:shadow-lg transition-shadow duration-300"
        />
      </div>
    </div>
  );
